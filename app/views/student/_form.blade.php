      <table class="tb">
        ...
        <tr>
          ...
          <tr>
              <td class="td_w120">作品名称</td>
              <td>{{ Form::text('production' ) }}
                  {{ $errors->first('production', '<div style="color:red">:message</div>') }}          </td>

              </td>
          </tr>

          <tr>
              <td class="td_w120">辅导教师</td>
              <td>{{ Form::text('teacher') }}
                  {{ $errors->first('teacher', '<div style="color:red">:message</div>') }}          </td>

              </td>
          </tr>

          <tr>
              <td class="td_w120">作品照片</td>
              <td>{{ Form::file('pic') }}
                  {{ $errors->first('pic', '<div style="color:red">:message</div>') }}          </td>
