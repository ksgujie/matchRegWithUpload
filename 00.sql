...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`matchupload` /*!40100 DEFAULT CHARACTER SET utf16 */;
...
insert  into `items`(`id`,`name`,`type`,`max`) values (1,'环保任意作品','个人项目',0);
...
insert  into `students`(`id`,`name`,`production`,`teacher`,`user_id`,`group_id`,`item_id`,`remark`,`created_at`,`updated_at`) values (1,'aaaa','fff','fff',33,1,1,'ffff','2016-04-20 14:52:31','2016-04-20 14:52:31'),(2,'aaaa','fff','fff',33,1,1,'ffff','2016-04-20 14:54:19','2016-04-20 14:54:19'),(3,'环保','fff','fff',33,1,1,'','2016-04-20 14:54:40','2016-04-20 14:54:40'),(4,'环保','fff','fff',33,1,1,'','2016-04-20 16:26:42','2016-04-20 16:26:42'),(5,'环保','fff','fff',33,1,1,'','2016-04-20 16:27:29','2016-04-20 16:27:29');
